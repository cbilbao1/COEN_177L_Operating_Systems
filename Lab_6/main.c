...
PRIVATE void announce(void)
{
  ...
  printf("\nMINIX %s.%s. "
	...
	"(" _SVN_REVISION ")\n"
#endif
      "Copyright 2010, Vrije Universiteit, Amsterdam, The Netherlands. This used to be the copyright statement, but now I have added onto it! (Carlo Bilbao)\n",
      OS_RELEASE, OS_VERSION);
  printf("MINIX is open source software, see http://www.minix3.org. This used to be the copyright statement, but now I have added onto it! (Carlo Bilbao)\n");
}
