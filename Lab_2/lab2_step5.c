// Name: Carlo Bilbao 
// Date: 1/19/23
// Title: Lab2 – step 5, create delays for each process
...
int main(int argc, char *argv[]) {
    //Check if the user inputted a delay, inputting 4 delays for 4 processes
    if (argc != 5){
    ...
    int n4 = atoi(argv[4]); // n microseconds is taken as command-line argument
